...
from src.snake_game_multipage import snake_game
...
if 'snake_count' not in st.session_state:
    st.session_state.snake_count = 0
...
if st.session_state.snake_count < 1:
...
if st.session_state.snake_count > 0:
    # creating a side menu bar
    menu = ["Introduction", "The Game"]
